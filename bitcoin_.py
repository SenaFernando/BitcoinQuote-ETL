...
# Parâmetros de requisição para obter a cotação do Bitcoin
parameters = {
    'symbol': "BTC",  # identificação do Bitcoin pelo símbolo
...
def consultar_cotacao_bitcoin():
    try:
        ...
        if 'data' in data and 'BTC' in data['data']:
            ...
            print("Erro ao obter a cotação do Bitcoin:",
...
if __name__ == "__main__":
    print("Iniciando o agendamento para consultar a cotação do Bitcoin a cada 15 segundos...")
    while True:
